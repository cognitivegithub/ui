Ext.define('Application.components.ProcedureSubjectCodesPanel', {
  ...
  initComponent : function () {
    ...
    Ext.apply(this, {
      ...
      buttons: [{
        ...
        handler: function() {
          var win = new Ext.Window({
            title: 'Добавление кода предмета закупки',
            width: 700,
            height: 400,
            ...
            items: [{
              ...
              type: 'procedure_subject_codes',
              selection: this.selection,
              listeners: {
                nomenclature_selected: function(n) {
                  n.subject_code_id = n.id;
                  delete n.id;
      ...
      addCategory: function(n) {
        ...
        cc_panel.add({
          ...
          procedure_subject_codes: {
            id:               n.id,
            subject_code_id:  n.subject_code_id,
            name:             n.text,
          ...
          getValue: function() {
            return this.procedure_subject_codes;
          }
        });            
      },
    ...
    Application.components.ProcedureSubjectCodesPanel.superclass.initComponent.call(this);
  }
});
