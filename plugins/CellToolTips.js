...
/**
 * Ext.ux.grid.CellToolTips plugin for Ext.grid.GridPanel
 *
 ...
 * @version 1.3
 *
 * @class Ext.ux.grid.CellToolTips
 * @extends Ext.util.Observable
 */
Ext.ux.grid.CellToolTips = function(config) {
    var cfgTips;
    ...
    Ext.ux.grid.CellToolTips.superclass.constructor.call(this, config);
    if( config.tipConfig ) {
...
// plugin code
Ext.extend( Ext.ux.grid.CellToolTips, Ext.util.Observable, {
    version: 1.3,
    /**
     ...
     * @param {Ext.ux.grid.CellToolTips} ctt
     * @param {Ext.grid.GridPanel} grid
     */
     ...
     * @param {Ext.ux.grid.CellToolTips} ctt The CellToolTips object
