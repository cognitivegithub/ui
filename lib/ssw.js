...
(function (window, document) {
	...
	implementation.add(mixins.serialized, {
		...
		read : function () {
			var serializedString = localStorage.getItem(this.storeName);
			return serializedString === null ? "" : serializedString.toString();
		},

		save : function (serializedString) {
			return localStorage.setItem(this.storeName, serializedString);
		},
	...
	implementation.add(mixins.serialized, {
		...
		isAvailable : function () {
			return Boolean(!Ext.isIE && document.documentElement && document.documentElement.addBehavior);
		},
